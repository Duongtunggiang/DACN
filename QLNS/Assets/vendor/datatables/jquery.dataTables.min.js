...
a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"Sau",sPrevious:"Trước"},sEmptyTable:"No data available in table",sInfo:"Hiện _START_ đến _END_ của _TOTAL_ bản ghi",sInfoEmpty:"Hiện 0 đến 0 của 0 bản ghi",
sInfoFiltered:"(lọc từ _MAX_ bản ghi)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Hiện _MENU_ bản ghi",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Tìm kiếm:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Không tồn tại bản ghi nào"},oSearch:h.extend({},l.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};
